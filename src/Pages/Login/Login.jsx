...
const Login = () => {
   ...
   return (
      <div className="flex flex-col md:flex-row h-full py-12 lg:py-32 items-center bg-[url(https://i.ibb.co/17R85wC/authentication.png)]">
            ...
            <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
               ...
               <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="p-6 pt-0">
                     ...
                     <p className="flex justify-center mt-6 text-xs md:text-sm antialiased font-light leading-normal text-inherit">
                        Don't have an account?
                        <Link
                           to="/register"
                           className="block ml-1 text-xs md:text-sm antialiased font-bold leading-normal text-[#FF3811]"
                        >
                           Register
                        </Link>
                     </p>
