...
const Register = () => {
   ...
   return (
      <div className="flex flex-col md:flex-row py-12 md:py-32 h-full items-center bg-[url(https://i.ibb.co/17R85wC/authentication.png)]">
         ...
         <div className="w-1/2 flex justify-center">
            <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
               <div className="relative grid mx-4 mb-4 -mt-6 overflow-hidden text-white shadow-lg h-28 place-items-center rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500">
                  <h3 className="block text-2xl md:text-3xl  font-extrabold leading-snug tracking-normal text-white">
                     Register Now!!
                  </h3>
               </div>
               <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="p-6 pt-0">
                     ...
                     <p className="flex justify-center mt-6 text-medium font-light leading-normal text-inherit">
                        Or, Sign In with
                     </p>
                     <SocialLogin></SocialLogin>
                     <p className="flex justify-center mt-6 text-xs md:text-sm font-light leading-normal text-inherit">
                        Have an account?
                        <Link
                           to="/login"
                           className="block ml-1 text-xs md:text-sm font-bold leading-normal text-[#FF3811]"
                        >LogIn
                        </Link>
                     </p>
                  </div>
