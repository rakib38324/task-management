...
const Footer = () => {
   return (
      <div>
          <footer>
      <div className="footer p-3 lg:p-10 bg-neutral text-neutral-content">
         <aside className="flex items-center">
            <img src="/logo.webp" className="w-16 h-16 rounded-full" />
            <p>SCC Technovision Inc.<br />Providing reliable tech since 2013</p>
         </aside>
         <nav>
      ...
      <div className="footer footer-center p-4 bg-base-300 text-base-content">
            <aside>
               <p>Copyright © 2013 - All right reserved by SCC Technovision Inc.</p>
            </aside>
         </div>
   </footer>
      </div>
